...
import { LocateConfirmation } from "./LocateConfirmation";
import { ModelRow } from "./ModelRow";
import { OPEN_TAB, CATALOGUE_TABS, lastChoice, slugFor } from "./shared";
import type { CatalogueTab, RowProps } from "./shared";
import type {
  Capabilities,
  ConfigWarning,
  ImportVerdict,
